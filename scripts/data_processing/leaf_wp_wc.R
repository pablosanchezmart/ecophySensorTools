...
### 02/2025 radar campaign ####

wp <- readxl::read_excel("C:/Users/psanche2/OneDrive - University of Edinburgh/postdoc_UoE/data/caxuana_physiology/caxuana_leaf_water_content_water_potential/caxiuana_water_potentials_vwc_02_2025.xlsx",
                         sheet = 1) %>%
  mutate(radar = TRUE)

wc <- readxl::read_excel("C:/Users/psanche2/OneDrive - University of Edinburgh/postdoc_UoE/data/caxuana_physiology/caxuana_leaf_water_content_water_potential/caxiuana_water_potentials_vwc_02_2025.xlsx",
                         sheet = 2) %>%
  mutate(id_radar_replique = paste0(plot, "_", ID, "_", radar_replique)) %>%
  select(-ID, -radar_replique, -plot, -date, -notes)
...
tail(radar_wp_wc)
unique(radar_wp_wc$id)
write_csv(radar_wp_wc, file = "data_processed/leaf_wp_wc/radar_wp_wc_02_2025.csv")


### 04/2025 radar campaign ####

wp <- readxl::read_excel("C:/Users/psanche2/OneDrive - University of Edinburgh/postdoc_UoE/data/caxuana_physiology/caxuana_leaf_water_content_water_potential/caxiuana_water_potentials_vwc_04_2025.xlsx",
                         sheet = 1) %>%
  mutate(radar = TRUE)

wc <- readxl::read_excel("C:/Users/psanche2/OneDrive - University of Edinburgh/postdoc_UoE/data/caxuana_physiology/caxuana_leaf_water_content_water_potential/caxiuana_water_potentials_vwc_04_2025.xlsx",
                         sheet = 2) %>%
  mutate(id_radar_replique = paste0(plot, "_", ID, "_", radar_replique)) %>%
  select(-ID, -radar_replique, -plot, -date, -notes)
...
tail(radar_wp_wc)
unique(radar_wp_wc$id)
write_csv(radar_wp_wc, file = "data_processed/leaf_wp_wc/radar_wp_wc_04_2025.csv")


### 06/2025 radar campaign ####

wp <- readxl::read_excel("C:/Users/psanche2/OneDrive - University of Edinburgh/postdoc_UoE/data/caxuana_physiology/caxuana_leaf_water_content_water_potential/caxiuana_water_potentials_vwc_06_2025.xlsx",
                         sheet = 1) %>%
  mutate(radar = TRUE)

wc <- readxl::read_excel("C:/Users/psanche2/OneDrive - University of Edinburgh/postdoc_UoE/data/caxuana_physiology/caxuana_leaf_water_content_water_potential/caxiuana_water_potentials_vwc_06_2025.xlsx",
                         sheet = 2) %>%
  mutate(id_radar_replique = paste0(plot, "_", ID, "_", radar_replique)) %>%
  select(-ID, -radar_replique, -plot, -date, -notes)
...
tail(radar_wp_wc)
unique(radar_wp_wc$id)
write_csv(radar_wp_wc, file = "data_processed/leaf_wp_wc/radar_wp_wc_06_2025.csv")


### 11/2025 radar campaign ####

wp <- readxl::read_excel("C:/Users/psanche2/OneDrive - University of Edinburgh/postdoc_UoE/data/caxuana_physiology/caxuana_leaf_water_content_water_potential/caxiuana_water_potentials_vwc_11_2025.xlsx",
                         sheet = 1) %>%
  mutate(radar = TRUE)

wc <- readxl::read_excel("C:/Users/psanche2/OneDrive - University of Edinburgh/postdoc_UoE/data/caxuana_physiology/caxuana_leaf_water_content_water_potential/caxiuana_water_potentials_vwc_11_2025.xlsx",
                         sheet = 2) %>%
  mutate(id_radar_replique = paste0(plot, "_", ID, "_", radar_replique)) %>%
  select(-ID, -radar_replique, -plot, -date, -notes)
...
tail(radar_wp_wc)
unique(radar_wp_wc$id)
write_csv(radar_wp_wc, file = "data_processed/leaf_wp_wc/radar_wp_wc_11_2025.csv")


### 01/2026 radar campaign ####

wp <- readxl::read_excel("C:/Users/psanche2/OneDrive - University of Edinburgh/postdoc_UoE/data/caxuana_physiology/caxuana_leaf_water_content_water_potential/caxiuana_water_potentials_vwc_01_2026.xlsx",
                         sheet = 1) %>%
  mutate(radar = TRUE,
...
wc <- readxl::read_excel("C:/Users/psanche2/OneDrive - University of Edinburgh/postdoc_UoE/data/caxuana_physiology/caxuana_leaf_water_content_water_potential/caxiuana_water_potentials_vwc_01_2026.xlsx",
                         sheet = 2) %>%
  mutate(id_radar_replique = paste0(plot, "_", ID, "_", radar_replique)) %>%
  select(-ID, -radar_replique, -plot, -date, -notes)
...
tail(radar_wp_wc)
unique(radar_wp_wc$id)
write_csv(radar_wp_wc, file = "data_processed/leaf_wp_wc/radar_wp_wc_01_2026.csv")


### 03/2026 radar campaign ####

wp <- readxl::read_excel("C:/Users/psanche2/OneDrive - University of Edinburgh/postdoc_UoE/data/caxuana_physiology/caxuana_leaf_water_content_water_potential/caxiuana_water_potentials_vwc_03_2026.xlsx",
                         sheet = 1) %>%
  mutate(radar = TRUE,
         WP_pd_1 = as.numeric(WP_pd_1),
         WP_pd_2 = as.numeric(WP_pd_2),
...
wc <- readxl::read_excel("C:/Users/psanche2/OneDrive - University of Edinburgh/postdoc_UoE/data/caxuana_physiology/caxuana_leaf_water_content_water_potential/caxiuana_water_potentials_vwc_03_2026.xlsx",
                         sheet = 2) %>%
  mutate(id_radar_replique = paste0(plot, "_", ID, "_", radar_replique)) %>%
  select(-ID, -radar_replique, -plot, -date, -notes)
...
all_wp_wc <- do.call(bind_rows, args = all_wp_wc_list) %>% 
  filter(!is.na(date)) %>% 
  arrange(date) %>%
  select(id, radar_replique, plot, everything(), -"...18")
...
unique(all_wp_wc)
all_wp_wc %>%
  filter(date %in% c("2025-11-28", "2025-11-29")) %>%
  ggplot() + geom_boxplot(aes(x = campaign, color = plot, y = wp_md))
