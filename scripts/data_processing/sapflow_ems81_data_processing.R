...
raw_folder_in <- "C:/Users/psanche2/OneDrive - University of Edinburgh/postdoc_UoE/data/caxuana_physiology/caxuana_sapflow/2025-02-25"
# processed_file_out <- paste0("data_processed/sapflow/processed_saplfow_", Sys.Date(), ".csv")
processed_file_out <- paste0("data_processed/sapflow/processed_sapflow_2025-02-25.csv")
...
raw_folder_in <- "C:/Users/psanche2/OneDrive - University of Edinburgh/postdoc_UoE/data/caxuana_physiology/caxuana_sapflow/2025-03-20"
# processed_file_out <- paste0("data_processed/sapflow/processed_saplfow_", Sys.Date(), ".csv")
processed_file_out <- paste0("data_processed/sapflow/processed_sapflow_2025-03-20.csv")
...
raw_folder_in <- "C:/Users/psanche2/OneDrive - University of Edinburgh/postdoc_UoE/data/caxuana_physiology/caxuana_sapflow/2025-04-30"
# processed_file_out <- paste0("data_processed/sapflow/processed_saplfow_", Sys.Date(), ".csv")
processed_file_out <- paste0("data_processed/sapflow/processed_sapflow_2025-04-30.csv")
...
raw_folder_in <- "C:/Users/psanche2/OneDrive - University of Edinburgh/postdoc_UoE/data/caxuana_physiology/caxuana_sapflow/2025-05-27"
# processed_file_out <- paste0("data_processed/sapflow/processed_saplfow_", Sys.Date(), ".csv")
processed_file_out <- paste0("data_processed/sapflow/processed_sapflow_2025-05-27.csv")
...
raw_folder_in <- "C:/Users/psanche2/OneDrive - University of Edinburgh/postdoc_UoE/data/caxuana_physiology/caxuana_sapflow/2025-06-26"
# processed_file_out <- paste0("data_processed/sapflow/processed_saplfow_", Sys.Date(), ".csv")
processed_file_out <- paste0("data_processed/sapflow/processed_sapflow_2025-06-26.csv")
...
for(ind in unique(gf_clean_sapflow_data_metadata$ID)){
  ...
  area_bl_ind.plot <- plotTimeSeries(data = ind_data,
                                ...
                                xLab = "", 
                                yLab = "gf sapflow per area (kg/h cm)", 
                                lineOrPoint = "line", 
                                colorVar = ID)
